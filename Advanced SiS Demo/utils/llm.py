...
Now generate {requested_suggestions} follow-up questions that encourage the user to explore the data in more depth. Do not include specific IDs or direct references to specific accounts or companies or firms or records in your suggestions. The tone should be formal and concise. Please provide questions that are precise and non-ambiguous.
...
* Do not include specific IDs, account numbers, company IDs, firm IDs or other sensitive identifiers in the summary. Highlight trends, patterns, or aggregate insights instead.
